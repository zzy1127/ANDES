...
from andes.utils.storage import StorageABC
import pandas as pd
...
class ANDESGenerator(OperatorABC):
    ...
    def run(self, storage: StorageABC, input_configs: list = None, output_instruction_key: str = "instruction", output_output_key: str = "output", output_difficulty_key: str = "difficulty"):
        ...
        for config in input_configs:
            ...
            task_type = None
            if self.use_task_diversity and getattr(self.prompt, 'task_types', None) and not format_requirement:
